...
public class Test_CourseManagementSystem_03 {
    ...
    void testingExamCourse(){
        ExamCourse examCourse1=new ExamCourse("Manish Patel", 10000);
        String resS=examCourse1.getName();
        double resI=examCourse1.getFees();

        Assertions.assertEquals(10000, resI);
        Assertions.assertEquals("Manish Patel", resS);
    }
    @Test
    void testingResearchCourse(){
        ResearchCourse researchCourse=new ResearchCourse("Manish Patel",12000);
    ...
    void testAssignmentCourse(){
        AssignmentCourse assignmentCourse=new AssignmentCourse("Manish Patel",15000);
    ...
    void testCourse(){
        ...
        Assertions.assertEquals("Manish Patel", course1.getName());
    }
    @AfterAll
    static void testDepartment(){
        ...
        ExamCourse examCourse=new ExamCourse("Manish Patel", 10000);
